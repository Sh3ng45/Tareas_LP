...
public class GraphGenerator {
    ...
    /**
    * Metodo auxiliar de generar que efectua la generacion del mapa
    *
    * @param N : profundidad del mapa
    * @param seed : Rango de numero aleatorio
    *
    * @return SortedSet<Edge> : Retorna un sorteo de edges
    */
    ...
    /**
    * Hace llamado a su metodo auxiliar de mismo nombre y con este genera el mapa
    *
    * @param N : profundidad del mapa
    *
    * @return SortedSet<Edge> : Retorna un sorteo de edges que sera el mapa
    */
}
